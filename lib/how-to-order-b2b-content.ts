...
export const HOW_TO_ORDER_B2B_BLOCKS: readonly HowToOrderB2bBlockContent[] = [
  {
    ...
    titleVi: "Thanh toán",
    bodyEn:
      "We **primarily** accept **T/T**, **L/C**, and **Western Union** for bulk **FCL** orders. We also support **PingPong** for secure and fast **sample fees**.",
    bodyZh:
  ...
  },
  {
    ...
    titleVi: "Vận chuyển",
    bodyEn:
      "We provide **Global FCL (Full Container Load)** sea freight to all **major international ports**, including **direct routes to Vietnam**.",
    bodyZh:
      "我们提供**全球整柜（FCL）**海运服务，覆盖全球各大**主要港口**，并拥有直达**越南**等地区的**优势特快航线**。",
    bodyVi:
